...
!===== SETTING UP SPONGE ZONE PARAMETERS
 ...
 select case(nn)
 case(1); szr(0,nn)=one/szth1; szp(0,nn)=-domlen+szth1; szr(1,nn)=one/(szth1+szxt); szp(1,nn)=domlen-szth1
 case(2); szr(0,nn)=one/szth2; szp(0,nn)=-domlen+szth2; szr(1,nn)=one/szth2; szp(1,nn)=domlen-szth2
 case(3); szr(0,nn)=zero; szp(0,nn)=zero; szr(1,nn)=zero; szp(1,nn)=zero
 end select
 end do
